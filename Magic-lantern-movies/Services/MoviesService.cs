...
namespace Services
{
    public class MoviesService
    {
        ...
        public async Task InitializeMoviesAsync()
        {
            ...
            {
                Debug.WriteLine("Failed to reach api! Using preset data..");
                try
                {
                    ...
                    var movies = new List<Movie>
                {
                    ...
                    new()
                    {
                        ...
                        Categories = new() {"Drama","Tragedy","Crime"},
                    ...
                    new()
                    {
                        ...
                        Categories = new() {"Action","Tragedy","Superhero","Epic"},
                    ...
                    new()
                    {
                        ...
                        Categories = new() {"Disaster","Parody","Superhero"},
                    ...
                    new()
                    {
                        ...
                        Categories = new() {"Adventure","Parody","Comedy" },
                    ...
                    new()
                    {
                        ...
                        Categories = new() {"Animation","Comedy","Family","Motorsport","Adventure"},
